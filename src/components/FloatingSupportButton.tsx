...
import { Bot, MessageSquare, Phone, X } from 'lucide-react';
                ...
                <div className="relative flex flex-col items-center gap-2">
                    ...
                    >
                         <div className="flex items-center gap-2">
                             <span className="bg-background text-foreground text-sm rounded-md px-3 py-2 shadow-lg whitespace-nowrap">Chat with AI</span>
                             <Button size="icon" className="rounded-full w-14 h-14" onClick={() => setIsChatOpen(true)}>
