...
const CountdownTimer = ({ targetDate }: { targetDate: string }) => {
    ...
    if (isExpired) {
        return <div className="text-xl font-bold text-yellow-300">Offer Expired!</div>;
    }
        ...
        {latestOffer && (
          <section id="limited-offer" className="offer-section">
              <div className="offer-content">
                  <h2 className="text-3xl md:text-4xl font-headline font-bold mb-2">{latestOffer.title}</h2>
                  <p className="text-lg md:text-xl mb-6">Flat <span className="text-yellow-400 font-bold">{latestOffer.discountPercentage}% Off</span> on your next purchase!</p>
                  <CountdownTimer targetDate={latestOffer.endDate} />
                  <Button size="lg" className="mt-8 bg-primary hover:bg-primary/90 text-primary-foreground">
                      <Link href={`https://wa.me/911234567890?text=I'm_interested_in_the_${latestOffer.code}_offer!`}>
